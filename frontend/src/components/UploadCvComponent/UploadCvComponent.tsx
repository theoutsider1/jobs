...
export const UploadCvComponent: React.FC<uploadCvCandidatProps> = ({isOpen , isClose})=> {
    ...
    return(
        ...
        <div className="bg-third flex flex-col justify-center items-center rounded-md">
            ...
            <label htmlFor="dropzone-file" className=" p-14 flex justify-center items-center border-2 border-gray-300 border-dashed rounded-lg bg-third">
