...
export const ChooseSpace= ()=> {
  ...
  return (
    <div className="h-screen  max-w-full mx-auto bg-secondary flex flex-col justify-start items-center ">
      ...
      <div className="flex gap-56">
          ...
          <div className="flex flex-col">
            ...
            {/* DownLoad svg Col 2 */}
            <div className=" mt-48 flex justify-start items-center gap-8 pb-5">
              <div>
          ...
          <div className="flex flex-col">
            <div>
              <h4 className="text-4xl font-semibold">1 Créer le compte</h4>
            </div>
            <div className="flex flex-row justify-center p-5">
