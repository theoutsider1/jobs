      ...
      <div className="w-3/4 ">
        <div className="w-full flex justify-center items-center ">
          <h3 className="text-5xl font-semibold">
            Lancer votre offer d'emploi
          </h3>
        </div>
        <div className="w-full p-6 bg-third flex justify-start items-start">
              ...
              <ul>
                ...
                <li className="p-3">
                  <div className=" mx-14 flex flex-row-4 justify-center">
                    ...
                    <div className="w-3/4">
                      <textarea
                        id="nomComplet"
                        className="block w-full rounded-md border-0 h-24 py-1.5 pl-3 pr-1.5 text-gray-900 ring-1 ring-inset ring-gray-300 "/>
                    </div>
                  </div>
                </li>
                <li className="p-3">
                  <div className=" mx-14 flex flex-row-4 justify-center">
                    ...
                    <div className="w-3/4">
                    <button id="dropdownDefaultButton" onClick={HandleToggleContactDropdown} data-dropdown-toggle="dropdown-list" className="w-full text-white bg-fourth hover:bg-darkk font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center justify-between" type="button">
                            {selectedContract}
                ...
                <li className="p-3">
                  <div className=" mx-14 flex flex-row-4 justify-center">
                    ...
                    <div className="w-3/4">
                    <button id="dropdownDefaultButton" onClick={handleTypeTravailToggle} data-dropdown-toggle="dropdown-list" className="w-full text-white bg-fourth hover:bg-darkk font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center justify-between" type="button">
                            {selectedTypeTravail}
                        <svg className="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                            <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m1 1 4 4 4-4"/>
                        </svg>
